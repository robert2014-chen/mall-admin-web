<template>
  <div>
    ...
    <div class="robert-tabs">
      <span :class=" 0==activeTabIndex&&'active'" @click="changeActiveTab(0)">账号信息</span>
      <span :class=" 1==activeTabIndex&&'active'" @click="changeActiveTab(1)">个人信息</span>
    </div>
    <!--账号信息-->
    <div :class=" [0!=activeTabIndex&&'robert-non-active', 'robert-dtails']">
    ...
    <!--个人信息-->
    <div :class=" [1!=activeTabIndex&&'robert-non-active','robert-dtails']">
      <div v-if="null==person" style="width: 100%;font-size: 12px;color: red;text-align: center">
        <span style="width:100%;">当前账号没有绑定个人！！！</span>
      </div>
